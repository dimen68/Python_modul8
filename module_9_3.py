...
print(f'тип объекта: {first_result}') # вывод типа объекта - generator
print(list(first_result)) # вывод результата работы генераторной сборки
print(f'тип объекта: {second_result}') # вывод типа объекта - generator
print(list(second_result)) # вывод результата работы генераторной сборки


print('\nРезультат переделки в списковую сборку:')
first_result = [abs(len(f) - len(s)) for f, s in zip(first, second) if len(f) != len(s)]
second_result = [len(first[i]) == len(second[i]) for i in range(len(first))]
...
print(second_result) # вывод результата работы генераторной сборки
